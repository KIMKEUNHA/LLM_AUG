...
def load_config():
    ...
    parser.add_argument("--exp_name", type=str, default="IMDB")
    parser.add_argument("--seed", type=int, default=42)

    ## WANDB
    parser.add_argument("--wandb_project", type=str, default="AICAPSTONE")
    ...
    parser.add_argument("--dataset", type=str, default="origin")
    ...
    parser.add_argument(
        "--gpu_strategy", type=str, default="null", help="Options: null, ddp, dp, ..."
    )
    ...
    parser.add_argument("--checkpoint_monitor", type=str, default="val_accuracy")
