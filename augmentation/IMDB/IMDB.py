...
for i in range(3000):
    ...
    #text = "Given a binary sentiment classification dataset consisting of texts from movie reviews and labels for each text, perform the task of classifying whether the text is positive or negative. Create at least two new entries similar to the provided examples. Ensure each text has more than 4 sentences.\n\nExample dataset :\n\n"
    num_label = 2
    example_num = 2
    label_chk = {}
    len = 0
